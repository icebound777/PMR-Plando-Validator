...
allowed_locations: dict[str, list[str]] = {
    ...
    "Jade Jungle": [
        ...
        "Beach - In Palm Tree 6 (one-off)",
        "Beach - In Palm Tree 6 (replenish)",
...
mutually_exclusive_items: dict[str, list[str]] = {
    ...
    "GoombarioUpgrade": ["UltraStone","SuperBlock"],
    "KooperUpgrade": ["UltraStone","SuperBlock"],
    "BombetteUpgrade": ["UltraStone","SuperBlock"],
    "ParakarryUpgrade": ["UltraStone","SuperBlock"],
    "BowUpgrade": ["UltraStone","SuperBlock"],
    "WattUpgrade": ["UltraStone","SuperBlock"],
    "SushieUpgrade": ["UltraStone","SuperBlock"],
    "LakilesterUpgrade": ["UltraStone","SuperBlock"],
    "SuperBlock": [
        "GoombarioUpgrade",
        "KooperUpgrade",
        "BombetteUpgrade",
...
# These locations may not hold progression
illogical_locations: list[str] = [
    "Merluvlees House - Merlows Badges 1",
    "Merluvlees House - Merlows Badges 2",
    "Merluvlees House - Merlows Badges 3",
    "Merluvlees House - Merlows Badges 4",
